...
export const SINGLETONS: Record<string, SingletonDef> = {
  ...
  home: {
    ...
    group: "Website",
    fields: [
      { key: "hero.brandName", label: "Brand name", type: "text", required: true, group: "Hero", help: "Read out to screen readers as the page's main heading. The visible mark is drawn, not typed." },
      { key: "hero.descriptor", label: "Descriptor", type: "text", required: true, group: "Hero", help: "Tracked out under the wordmark, e.g. PLANT HIRE." },
      { key: "hero.tagline", label: "Tagline", type: "textarea", required: true, wide: true, group: "Hero", help: "One short line. The hero deliberately carries no paragraph — that copy lives in the section below." },
      { key: "hero.trustIndicators", label: "Credentials row", type: "stringlist", wide: true, group: "Hero", help: "Five items at most, or the row wraps awkwardly on a phone." },
      { key: "hero.media", label: "Hero images", type: "medialist", wide: true, group: "Hero", help: "Cross-faded in order. The first is also the image search engines and social cards use." },

      { key: "hero.partner.label", label: "Partner label", type: "text", group: "Hero partner", help: "Confirm the exact wording with the client — it states a relationship." },
      { key: "hero.partner.name", label: "Partner name", type: "text", group: "Hero partner" },
      { key: "hero.partner.logo", label: "Partner logo path", type: "text", group: "Hero partner", help: "A file under /public, e.g. /brand/partner-ism.png. Brand assets are not part of the photography library." },
      { key: "hero.partner.href", label: "Partner link", type: "url", group: "Hero partner" },
      ...
      { key: "introLead", label: "Lead paragraph", type: "textarea", required: true, wide: true, group: "Introduction", help: "Opens the section directly under the hero." },
